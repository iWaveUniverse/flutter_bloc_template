...
class WidgetSwitchApp extends StatelessWidget {
  final bool value;
  final ValueChanged<bool> onToggle;

  const WidgetSwitchApp(
      {super.key, required this.onToggle, required this.value});
...
class FlutterSwitch extends StatefulWidget {
  ...
  ///
  /// Defaults to [AppColors.instance.mainColor].
